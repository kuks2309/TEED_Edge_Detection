    ...
    if is_linux:
        ...
        config = {
            ...
            'CLASSIC': {
                ...
                'test_list': None,
                'train_list': None,
                'data_dir': 'D:/Image/20240229_pre',  # mean_rgb
                'yita': 0.5,
                'mean': [104.007, 116.669, 122.679, 137.86]
            },
        ...
        config = {
            ...
            'DCD': {'img_height': 240,
                    ...
                    'yita': 0.2,
                    'mean': [104.007, 116.669, 122.679, 137.86]},
            'PREVISION': {'img_height': 512,
                       'img_width': 612,
                       'test_list': 'test_pair.lst',
                       'train_list': 'train_pair.lst',
                       'data_dir': 'D:/FITO_2026/TEED/training_data/20241213',
                       'yita': 0.5,
                       'mean': [104.007, 116.669, 122.679, 137.86]}
        }
...
class TestDataset(Dataset):
    ...
    def _build_index(self):
        ...
        if self.test_data == "CLASSIC":
            ...
            if self.test_data.upper() in ['BIPED', 'BRIND','UDED','ICEDA', 'PREVISION']:
