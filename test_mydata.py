"""
Test TEED model trained on MYDATA
"""
import os
import sys
import cv2
...
TEST_DATA = 'MYDATA'
IS_LINUX = False
CHECKPOINT = 'checkpoints/MYDATA/best_model.pth'
OUTPUT_DIR = 'result/MYDATA'
...
def main():
    ...
    with torch.no_grad():
        for i, img_name in enumerate(image_files):
            ...
            # Resize to 1/4 (same as training)
